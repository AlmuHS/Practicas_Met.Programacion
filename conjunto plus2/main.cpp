...
int main(int argc, char *argv[]) {
    fracc f1(4,2), f2(3);
    conjuntoPlus *p = new conjuntoPlus("conjunto_p"), *q;
    cout << "*p: ";
    cout << *p << endl;
    //*p: { } – [0/1 1/1] (0/1 1/1)
    ...
    p = new conjuntoPlus(fracc(3,3), fracc(4,3), "conjunto_p");
    //*p: { } – [3/3 4/3] (1/1 2/1)
    ...
    conjuntoPlus a(fracc(2,4), f1, "conjunto_a"), b("conjunto_b");
    fracc x(1), y(7,6);
    cout << "a: ";
    a.ver();
    cout << endl;
    ...
    conjunto *T[4];
    T[0]=new conjunto();
    T[1]=new conjuntoPlus(fracc(1,5),fracc(1,5), "conjunto1");
    T[2]=new conjunto();
    T[3]=new conjuntoPlus(1,2, "conjunto3");
    for(int i=0; i<4; i++) {
    T[i]->agregar(fracc(1,i+1));
    T[i]->agregar(fracc(1,5));
    T[i]->ver(); cout << endl;
    }
    cout << "borrando la fraccion menor...\n";
    borrarMin(T, 4); //prohibe la fraccion menor
    for(int i=0; i<4; i++) {
        T[i]->ver(); cout << endl;
        delete T[i];
    }
